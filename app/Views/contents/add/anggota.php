...
<div class="card card-primary">
    ...
    <form method="POST" action="<?= route_to('save_anggota'); ?>" class="needs-validation" novalidate="">
        <?= csrf_field(); ?>
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control <?= ($valid->hasError('nama')) ? 'is-invalid' : ''; ?>" name="nama" value="<?= old('nama'); ?>" placeholder="Nama Anggota">
                ...
                <div class="form-group col-md-7">
                    ...
                    <div class="input_group"></div>
                    <input type="text" class="form-control <?= ($valid->hasError('alamat')) ? 'is-invalid' : ''; ?>" name="alamat" value="<?= old('alamat'); ?>" placeholder="Alamat">
                    <div class="invalid-feedback">
