...
<div class="card card-primary">
    ...
    <form method="POST" action="<?= route_to('save_pinjam'); ?>" class="needs-validation" novalidate="">
        <?= csrf_field(); ?>
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    ...
                    echo form_dropdown('anggota', $data, old('anggota'), 'class="form-control selectric "');
                    ?>
                </div>
                <div class="form-group col-md-4">
                    ...
                    echo form_dropdown('buku', $data, old('buku'), 'class="form-control selectric "');
                    ?>
                </div>
